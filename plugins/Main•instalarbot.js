...
let texto = `🌸 *Instalación de ${botname}*
...
git clone https://github.com/ianalejandrook15x/${botname}Bot-MD

cd ${botname}Bot-MD && yarn install && npm install 
...
conn.reply(m.chat, 'git clone https://github.com/ianalejandrook15x/${botname}Bot-MD && cd ${botname}Bot-MD', m, rcanal)
await delay(1000 * 1)
